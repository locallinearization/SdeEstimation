...
% FilterMethod='StochFilter';         % Stochastic LL filter with a priori artificial points between observations
...
switch FilterMethod
    ...
    case 'DeterFilter'
       n_m = length(t);
       mpts = 100.*ones(1,n_m);   % a priori artificial points between observation times
       LLF = LLfilter(t,Z,Xf0,Pf0,Theta,FileNames,LKWindow,mpts);
    case 'StochFilter'
       n_m = length(t);

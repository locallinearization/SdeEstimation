...
% Model definition
Const_LinearOscillator_Demo;

load data_LinearOscillator_Demo
Z=datos;
...
LB_T=[ 0 20 0 0];            % lower bound
UB_T=[20 40 2 2];            % upper bound
ThetaIndex=[1 2 3 4];
...
Theta0=Theta;    
Theta0(ThetaIndex)=[2 38 0.05 1.7];
...
switch OptimMethod
  ...
  case 'UMDA+fmincon'
    ...
    OptimOptions.PopSizeRate = 25;    % PopSizeRate * length(ParVar) = Population Size;
    OptimOptions.NumGen = 12;         % Number of Generations

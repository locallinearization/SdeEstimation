...
% Model definition
Const_FitzhughNagumo_Demo;

load data_FitzhughNagumo_Demo  
Z=datos;
...
Theta0=Theta;     
Theta0(ThetaIndex)=[ 2  -3  0.5];    % example of fesaible parameter initial values
% Theta0(ThetaIndex)=[ -2  -3  0.5];   % example of unfesaible parameter initial values
